                        ...
                        <div class="form-item">
                            <div class="vertical-items-container">
                                ...
                                <div class="item">
                                    ...
                                    <input type="checkbox" id="dogCompatible_dog" name="temperment">
                                </div>
                                <div class="item">
                                    <label for="catCompatible_dog">Gets Along with Other Cats</label>
                                    <input type="checkbox" id="catCompatible_dog" name="temperment">
                                </div>
                                <div class="item">
                                    <label for="familyCompatible_dog">Suitable for Family and Children</label>
                                    <input type="checkbox" id="familyCompatible_dog" name="temperment">
                                </div>
                                <div class="error"></div>
                            </div>
                        </div>
                        ...
                        <div class="form-item">
                            <div class="vertical-items-container">
                                ...
                                <div class="item">
                                    ...
                                    <input type="checkbox" id="dogCompatible_cat" name="temperment">
                                </div>
                                <div class="item">
                                    <label for="catCompatible_cat">Gets Along with Other Cats</label>
                                    <input type="checkbox" id="catCompatible_cat" name="temperment">
                                </div>
                                <div class="item">
                                    <label for="familyCompatible_cat">Suitable for Family and Children</label>
                                    <input type="checkbox" id="familyCompatible_cat" name="temperment">
                                </div>
                                <div class="error"></div>
                            </div>
                        </div>
